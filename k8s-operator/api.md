...
| `livenessProbe` _[Probe](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.3/#probe-v1-core)_ | Container livenessProbe.<br />https://kubernetes.io/docs/tasks/configure-pod-container/configure-liveness-readiness-startup-probes/#configure-probes<br />By default Tailscale Kubernetes operator does not apply any liveness probe.<br />This can be combined with a defined TS_HEALTHCHECK_ADDR_PORT env var to check<br />a healthz endpoint. |  |  |
| `readinessProbe` _[Probe](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.3/#probe-v1-core)_ | Container readinessProbe.<br />https://kubernetes.io/docs/tasks/configure-pod-container/configure-liveness-readiness-startup-probes/#configure-probes<br />By default Tailscale Kubernetes operator does not apply any readiness probe.<br />This can be combined with a defined TS_HEALTHCHECK_ADDR_PORT env var to check<br />a healthz endpoint. |  |  |
